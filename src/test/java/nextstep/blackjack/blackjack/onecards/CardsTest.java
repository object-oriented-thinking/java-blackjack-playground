...
class CardsTest {
    ...
    void cards_atLeast_two() {
        assertDoesNotThrow(
            () -> new Cards(Arrays.asList(CLOVER_FOUR, CLOVER_THREE))
        );
    }
    ...
    void sumCards() {
        Cards cards = new Cards(Arrays.asList(CLOVER_FOUR, CLOVER_THREE));
    ...
    void sumCards_ace_and_ace() {
        Cards cards = new Cards(Arrays.asList(CLOVER_ACE, HEART_ACE));
    ...
    void sumCards_ace_and_jack() {
        Cards cards = new Cards(Arrays.asList(CLOVER_ACE, CLOVER_JACK));
